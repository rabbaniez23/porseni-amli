...
export function AboutSection() {
  ...
  return (
    <section id="about" className="py-20 bg-brutal-bg border-b-4 border-brutal-black font-sans overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-stretch">
          ...
          <div className="lg:col-span-7 flex flex-col justify-between space-y-8">
            <div className="space-y-6 text-left">
              <div
                data-aos="fade-right"
                className="about-left-header space-y-4"
              >
              ...
              <p
                data-aos="fade-up"
                data-aos-delay="150"
                className="about-left-desc text-lg font-bold leading-relaxed border-3 border-brutal-black bg-white p-6 shadow-brutal text-neutral-800"
              >
            ...
            <div
              ...
              data-aos-delay="300"
              className="about-quote bg-brutal-yellow text-brutal-black p-6 border-3 border-brutal-black shadow-brutal flex gap-4 items-start relative rotate-[-1deg]"
            >
          ...
          <div className="lg:col-span-5 flex flex-col justify-center">
            <div
              data-aos="fade-left"
              data-aos-delay="200"
              className="about-right-card bg-white border-3 border-brutal-black shadow-brutal p-8 space-y-6 text-left relative"
            >
              {/* Star Badge */}
