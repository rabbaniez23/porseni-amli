  ...
  return (
    <section className="py-20 bg-brutal-bg border-b-4 border-brutal-black font-sans">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Tab Headers */}
        <div className="flex flex-wrap border-b-4 border-brutal-black -mb-[4px] relative z-10">
          {tabs.map((tab, idx) => {
        ...
        {(() => {
          ...
          return (
            <div className="bg-white border-4 border-brutal-black shadow-brutal p-8 md:p-12 text-left transition-all">
